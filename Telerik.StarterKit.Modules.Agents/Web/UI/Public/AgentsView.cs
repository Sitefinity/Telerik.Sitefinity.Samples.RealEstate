...
using Telerik.StarterKit.Modules.Agents.Web.UI.Public.Designers;
...
{
    /// <summary>
    /// Represents ContentView control for agent items 
    /// </summary>
    [RequireScriptManager]
    [ControlDesigner(typeof(AgentsDesigner))]
    [PropertyEditorTitle(typeof(AgentsResources), "AgentsViewTitle")]
    public class AgentsView : ContentView
    {
        /// <summary>
        ...
        public override string ModuleName
        {
            get
            {
                if (String.IsNullOrEmpty(base.ControlDefinitionName))
                    return AgentsModule.ModuleName;
        ...
        public override string ControlDefinitionName
        {
            ...
            {
                if (String.IsNullOrEmpty(base.ControlDefinitionName))
                    return AgentsDefinitions.FrontendDefinitionName;
        ...
        public override string MasterViewName
        {
            get
            {
                ...
                return AgentsDefinitions.FrontendListViewName;
            }
            set
            {
        ...
        public override string DetailViewName
        {
            get
            {
                ...
                return AgentsDefinitions.FrontendDetailViewName;
            }
            set
            {
        ...
        public override string EmptyLinkText
        {
            get
            {
                return Res.Get<AgentsResources>().EditAgentsSettings;
            }
        }
    }
}
