...
{
    public class RelatedEventsDesigner : ControlDesignerBase
    {
        private const string layoutTemplateName = "Telerik.StarterKit.Widgets.Events.Resources.Views.RelatedEventsDesignerTemplate.ascx";
        private const string designerScriptName = "Telerik.StarterKit.Widgets.Events.Resources.Scripts.RelatedEventsDesigner.js";
        ...
        public override IEnumerable<ScriptReference> GetScriptReferences()
        {
            ...
            scripts.Add(new ScriptReference(RelatedEventsDesigner.designerScriptName, assembly));
