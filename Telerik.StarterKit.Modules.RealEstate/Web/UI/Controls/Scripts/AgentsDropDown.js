...
Telerik.StarterKit.Modules.RealEstate.Web.UI.Controls.AgentsDropDown = function (element) {

    Telerik.StarterKit.Modules.RealEstate.Web.UI.Controls.AgentsDropDown.initializeBase(this, [element]);
}

Telerik.StarterKit.Modules.RealEstate.Web.UI.Controls.AgentsDropDown.prototype =
{


    initialize: function () {
        Telerik.StarterKit.Modules.RealEstate.Web.UI.Controls.AgentsDropDown.callBaseMethod(this, "initialize");
    },
    ...
    get_value: function () {
        ...
        if (this.get_displayMode() == Telerik.Sitefinity.Web.UI.Fields.FieldDisplayMode.Write) {
            ...
            //            alert(result);
            //            alert(Array.prototype.isPrototypeOf(result));
...
Telerik.StarterKit.Modules.RealEstate.Web.UI.Controls.AgentsDropDown.registerClass('Telerik.StarterKit.Modules.RealEstate.Web.UI.Controls.AgentsDropDown', Telerik.Sitefinity.Web.UI.Fields.ChoiceField);